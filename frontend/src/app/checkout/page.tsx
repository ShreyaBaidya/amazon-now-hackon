      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-40">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            {economyMode ? (
              <>
                <p className="text-[13px] font-bold text-emerald-700">Economy mode is ON</p>
                <p className="text-[11px] text-ink2">Showing cheapest items per category · tap to turn off</p>
              </>
            ) : (
              <>
                <p className="text-[13px] font-semibold text-emerald-700">Try Economy mode</p>
